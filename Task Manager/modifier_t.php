...
if(isset($_POST['valider'])){
  ...
  if(isset($nom_agent) && isset($nom_machine)){
      //requête de modification
      $req = mysqli_query($con, "UPDATE tache SET nom_agent = '$nom_agent' , nom_machine = '$nom_machine' WHERE id = $id");
    ...
    <div class="wrapper"  >
      <div class="inner">
          ...
          <div class="image-holder">
              <img src="assets/img/tache.gif" alt="">
          </div>
          <form action="tache.php" method="post">
              <div id="ajouter"><span class=" h3" id="steg">Modifier</span> <span class=" h3" id="cti">Tache</span></div><br><br>
        

              <div class="form-wrapper">
                
                <select class="form-select" aria-label="Default select example" name="nom_agent" >
                  <option selected>Choisir un agent</option>
                  <option value="jaafer_cherni">jaafer_cherni</option>
                  <option value="kais_amri">kais_amri</option>
                  <option value="radhwen_rezgui">radhwen_rezgui</option>
                  <option value="anis_ben_mira">anis_ben_mira</option>
                  <option value="mourad_Khammasi">mourad_Khammasi</option>
                </select>
              </div><br><br>

              <div class="form-wrapper">
                <select class="form-select" aria-label="Default select example" name="nom_machine" >
                  <option selected>Choisir une Machine</option>
